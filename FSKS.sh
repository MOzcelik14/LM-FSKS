...
sudo apt update
sudo apt purge -y firefox thunderbird transmission-gtk hypnotix warpinator rhythmbox && sudo apt autoremove --purge -y
...
echo "========================================"
echo "== ZRAM ve Swapfile Konfigürasyonları =="
echo "========================================"
...
echo "============================================="
echo "== TLP Güç ve Performans Konfigürasyonları =="
echo "============================================="
